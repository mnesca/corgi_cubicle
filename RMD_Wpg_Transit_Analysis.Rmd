...
```{r Mutating and renaming, eval=FALSE}
...
```{r creating time to pass up eval=FALSE}
transitdataclean <- transitdataclean %>%
...
```{r adding categories for bus speed, eval=FALSE}
transitdataclean <- transitdataclean %>%
...
```{r creating day of week variable, eval=FALSE}
transitdataclean <- transitdataclean %>%
...
```{r month, include=TRUE, eval=TRUE}
transitdataclean %>%
...
```{r ggplot practice, include=TRUE, eval=TRUE}
transitdataclean %>% 
...
```{r more ggplot practice, include=TRUE, eval=TRUE}
transitdataclean %>%
